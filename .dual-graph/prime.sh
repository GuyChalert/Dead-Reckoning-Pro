#!/usr/bin/env bash
PORT=$(cat "/data/data/com.termux/files/home/code/Dead-Reckoning-Pro/.dual-graph/mcp_port" 2>/dev/null || echo 8080)
...
if [[ -f "/data/data/com.termux/files/home/code/Dead-Reckoning-Pro/CONTEXT.md" ]]; then
  echo ""
  echo "=== CONTEXT.md ==="
  cat "/data/data/com.termux/files/home/code/Dead-Reckoning-Pro/CONTEXT.md"
  echo "=== end CONTEXT.md ==="
fi
# Inject context store entries (decisions, tasks, next steps) — max 15 lines, 7-day window
STORE="/data/data/com.termux/files/home/code/Dead-Reckoning-Pro/.dual-graph/context-store.json"
